...
public class UsersServiceImpl extends ServiceImpl<UsersMapper, Users> implements UsersService {
    ...
    @Override
    @CacheEvict(allEntries = true)
    public boolean update(Users entity, QueryWrapper query) {
        return super.update(entity, query);
    }

    @Override
    @CacheEvict(key = "#entity.userId")
    public boolean updateById(Users entity, boolean ignoreNulls) {
        return super.updateById(entity, ignoreNulls);
    }

    @Override
    @CacheEvict(allEntries = true)
    public boolean updateBatch(Collection<Users> entities, int batchSize) {
    ...
    public Users getOne(QueryWrapper query) {
    ...
    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public List<Users> list(QueryWrapper query) {
    ...
    @Override
    @Deprecated
    public List<Users> listByIds(Collection<? extends Serializable> ids) {
