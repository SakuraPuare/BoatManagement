...
public class AlertsServiceImpl extends ServiceImpl<AlertsMapper, Alerts> implements AlertsService {
    ...
    @Override
    @CacheEvict(allEntries = true)
    public boolean update(Alerts entity, QueryWrapper query) {
        return super.update(entity, query);
    }

    @Override
    @CacheEvict(key = "#entity.alertId")
    public boolean updateById(Alerts entity, boolean ignoreNulls) {
        return super.updateById(entity, ignoreNulls);
    }

    @Override
    @CacheEvict(allEntries = true)
    public boolean updateBatch(Collection<Alerts> entities, int batchSize) {
        return super.updateBatch(entities, batchSize);
    }

    @Override
    @Cacheable(key = "#id")
    public Alerts getById(Serializable id) {
        return super.getById(id);
    }

    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public Alerts getOne(QueryWrapper query) {
    ...
    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public List<Alerts> list(QueryWrapper query) {
    ...
    @Override
    @Deprecated
    public List<Alerts> listByIds(Collection<? extends Serializable> ids) {
