...
VALUES ('管理员', '管理员'), ('商户', '商户'), ('供应商', '供应商'), ('船主', '船主'), ('普通用户', '普通用户');
-- 创建管理员和他的其他角色
INSERT INTO `accounts` ( `username`, `password`, `phone`, `email`, `role` )
VALUES ( 'admin', 'admin', '12345678901', 'admin@example.com', 0xff );
...
-- 创建商家示例
INSERT INTO `accounts` ( `username`, `password`, `phone`, `email`, `role` )
VALUES ( 'merchant', 'merchant', '12345678903', 'merchant@example.com', 0b11 );
INSERT INTO `merchants` ( `user_id`, `unit_id`, `status` )
VALUES ( '2', '1', 'APPROVED' );
INSERT INTO `user_role` ( `user_id`, `role_id` )
VALUES ( '2', '2' );
...
-- 创建船主
INSERT INTO `accounts` ( `username`, `password`, `phone`, `email`, `role` )
VALUES ( 'vendor', 'vendor', '12345678904', 'vendor@example.com', 0b101 );
INSERT INTO `vendors` ( `user_id`, `unit_id`, `status` )
VALUES ( '3', '1', 'APPROVED' );
INSERT INTO `user_role` ( `user_id`, `role_id` )
VALUES ( '3', '3' );
...
-- 创建普通用户
INSERT INTO `accounts` ( `username`, `password`, `phone`, `email`, `role` )
VALUES ( 'user', 'user', '12345678905', 'user@example.com', 1 );
INSERT INTO `user_role` ( `user_id`, `role_id` )
VALUES ( '4', '4' );
-- 实名认证一下
